      ...
      <div className="px-4 sm:px-0">
        <div className="mb-8">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-4xl font-bold text-gray-900 dark:text-gray-50 mb-2">Exercises</h1>
              <p className="text-gray-600 dark:text-gray-400">Manage your exercise library</p>
            </div>
            <button
        ...
        {showCreateForm && (
          <div className="mb-8 bg-white dark:bg-slate-800 rounded-xl shadow-lg border border-gray-200 dark:border-slate-700 p-6">
            <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-50 mb-4">Create New Exercise</h2>
            <form onSubmit={handleCreateExercise} className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="md:col-span-2">
                  <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Exercise Video (Optional)</label>
                  <input
                    type="file"
                    accept="video/mp4,video/quicktime,video/x-m4v"
                    className="w-full px-4 py-2 border border-gray-300 dark:border-slate-600 rounded-lg bg-white dark:bg-slate-700 text-gray-900 dark:text-gray-50 focus:ring-2 focus:ring-blue-500 focus:border-transparent file:mr-4 file:py-2 file:px-4 file:rounded-lg file:border-0 file:text-sm file:font-semibold file:bg-blue-50 dark:file:bg-blue-900/30 file:text-blue-700 dark:file:text-blue-300 hover:file:bg-blue-100 dark:hover:file:bg-blue-900/50"
                    onChange={(e) => {
                  ...
                  <p className="mt-1 text-xs text-gray-500 dark:text-gray-400">Supported formats: MP4, QuickTime, M4V (Max 20MB)</p>
                </div>
              </div>
              <div className="flex justify-end space-x-4">
                <button
                  ...
                  className="px-4 py-2 border border-gray-300 dark:border-slate-600 rounded-lg text-gray-700 dark:text-gray-300 bg-white dark:bg-slate-700 hover:bg-gray-50 dark:hover:bg-slate-600 transition-colors"
                >
                  Cancel
                </button>
                <button
        ...
        <div className="bg-white dark:bg-slate-800 shadow-lg rounded-xl border border-gray-200 dark:border-slate-700 overflow-hidden">
          {!Array.isArray(exercises) || exercises.length === 0 ? (
            <div className="px-6 py-12 text-center">
              <svg className="mx-auto h-12 w-12 text-gray-400 dark:text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 10V3L4 14h7v7l9-11h-7z" />
              </svg>
              <h3 className="mt-2 text-sm font-medium text-gray-900 dark:text-gray-50">No exercises</h3>
              <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">Get started by creating a new exercise.</p>
            </div>
          ) : (
            <div className="divide-y divide-gray-200 dark:divide-slate-700">
              {exercises.map((exercise) => (
                <div key={exercise.id} className="px-6 py-5 hover:bg-gray-50 dark:hover:bg-slate-700 transition-colors">
                  <div className="flex items-start justify-between">
                    <div className="flex-1">
                      <div className="flex items-center space-x-3 mb-2">
                        <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-50">{exercise.name}</h3>
